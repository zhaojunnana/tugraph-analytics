...
`snapshot_time_long` bigint(20) NOT NULL COMMENT 'Snapshot time long',
`checkpoint` bigint(20) COMMENT 'Snapshot checkpoint',
`snapshot_time` timestamp NOT NULL COMMENT 'Snapshot Time',
`finish_time` timestamp COMMENT 'Finish Time',
